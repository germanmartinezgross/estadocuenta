		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#protechestadocuenta-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"protechestadocuenta-display": {
								"semanticObject": "protechestadocuenta",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=protech.estadocuenta",
									"url": sap.ui.require.toUrl("protech/estadocuenta")
								}
							}
						}
					}
